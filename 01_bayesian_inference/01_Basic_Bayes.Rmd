...
sample_mean    <- 5/90
posterior_mean <- (alpha + 5)/(alpha + beta + 90 - 5)
...
because all conversion rates with non-zero probability are possible. Instead, 
there are only conversion rates that have a higher density than others.
